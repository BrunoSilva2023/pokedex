...
function convertPokemonToLi(pokemon) {
  ...
  return `
    <li class="pokemon ${pokemon.type}">
      ...
      <span class="defesa">Defesa: ${pokemon.defense}</span>
      <span class="ataqueEspecial">Ataque Especial: ${pokemon.specialAttack}</span>
      <span class="defesaEspecial">Defesa Especial: ${pokemon.specialDefense}</span>
      <span class="velocidade">Velocidade: ${pokemon.speed}</span>
